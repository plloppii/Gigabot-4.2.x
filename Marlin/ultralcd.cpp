...
void lcd_quick_feedback(const bool clear_buttons) {
  ...
  void _lcd_preheat(const int16_t endnum, const int16_t temph, const int16_t tempb, const int16_t fan) {
    ...
    void lcd_preheat_m2_e0_only() { _lcd_preheat(0, 225, -1, lcd_preheat_fan_speed[1]); _lcd_preheat(1, 220, -1, lcd_preheat_fan_speed[1]); _lcd_preheat(2, 180, -1, lcd_preheat_fan_speed[1]);}
      ...
      void lcd_preheat_m2_e0() { _lcd_preheat(0, 225, 60, lcd_preheat_fan_speed[1]); _lcd_preheat(1, 220, 60, lcd_preheat_fan_speed[1]); _lcd_preheat(2, 180, 60, lcd_preheat_fan_speed[0]);}
